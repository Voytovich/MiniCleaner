...
**Важливо:** [Попередження Windows SmartScreen](#попередження-windows-smartscreen)
...
2. Натисніть **"Виконати в будь-якому разі"**

**Чому це відбувається:**
- Windows SmartScreen блокує непідписані додатки за замовчуванням
- Це функція безпеки, але додаток безпечний для використання
